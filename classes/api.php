...
class api {
    ...
    public static function list_policies() {
        ...
        $sql = "SELECT d.id AS policyid, d.name, d.currentversionid, d.sortorder, d.type, d.component,
    ...
    public static function get_policy($policyid) {
        ...
        return $DB->get_record('tool_policy', ['id' => $policyid], 'id,name,currentversionid,sortorder,type,component', MUST_EXIST);
    }
